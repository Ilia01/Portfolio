---
title: "Rate Limiting and CSRF Protection in Node.js"
description: "Implementing rate limiting, CSRF protection, and security headers for Node.js APIs. Lessons from building Aegis2FA."
date: 2025-01-06
published: true
...
When building Aegis2FA, I realized rate limiting wasn't optional. Without it:
- Brute force attacks become trivial
- Database gets hammered by malicious requests
- Compute costs spiral
- Denial-of-service becomes easy

Rate limiting protects both the system and legitimate users.
